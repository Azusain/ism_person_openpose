...
PATH_ACTION_JIT = 'weights\\action.jit'
PATH_OPENPOSE_JIT = 'weights\\openpose.jit'
PATH_ACTION_PT = 'weights\\action.pt'
...
def detect(save_img=False):
    ...
    # 加载摔倒检测的模型
    print("加载摔倒检测的模型开始")
    net = jit.load(PATH_OPENPOSE_JIT)
    action_net = jit.load(PATH_ACTION_JIT)
    print("加载摔倒检测的模型结束")
    # Initialize
    set_logging()
    # 获取设备
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='C:\\Users\\azusaing\\Desktop\\Code\\tianwan\\ism_person_openpose\\data\\pics',
